...
${OBJECTDIR}/_ext/511e4115/c_source_template.o: ../src/c_source_template.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/c_source_template.o ../src/c_source_template.c

${OBJECTDIR}/_ext/d2aa2781/test_template.o: ../test/test_template.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d2aa2781
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2aa2781/test_template.o ../test/test_template.c
