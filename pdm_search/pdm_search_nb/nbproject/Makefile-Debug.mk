...
${OBJECTDIR}/_ext/511e4115/pdm_search.o: ../src/pdm_search.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../inc -I../src -I../test -I../../../Unity/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/pdm_search.o ../src/pdm_search.c

${OBJECTDIR}/_ext/d2aa2781/test_pdm_search.o: ../test/test_pdm_search.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d2aa2781
	${RM} "$@.d"
	$(COMPILE.c) -g -I../inc -I../src -I../test -I../../../Unity/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2aa2781/test_pdm_search.o ../test/test_pdm_search.c
