...
${OBJECTDIR}/_ext/511e4115/generic_circular_buffer.o: ../src/generic_circular_buffer.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../inc -I../src -I../test -I../../../Unity/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/generic_circular_buffer.o ../src/generic_circular_buffer.c
...
${OBJECTDIR}/_ext/d2aa2781/test_generic_circular_buffer.o: ../test/test_generic_circular_buffer.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../inc -I../src -I../test -I../../../Unity/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2aa2781/test_generic_circular_buffer.o ../test/test_generic_circular_buffer.c
